...
{
    [CustomEditor(typeof(VideoAdHolder))]
    public class VideoAdHolderEditor : Editor
    {

        protected VideoAdHolder targetHolder;

        protected SerializedProperty Prop_DisplayLandscape;
        protected SerializedProperty Prop_DisplayPotrait;
        ...
        {
            targetHolder = (VideoAdHolder)target;
            ...
            Prop_DisplayLandscape = serializedObject.FindProperty(nameof(targetHolder.LandScapeVideoDisplay));
            Prop_DisplayPotrait = serializedObject.FindProperty(nameof(targetHolder.PotraitVideoDisplay));
        ...
        public override void OnInspectorGUI()
        {
            ...
            using (new EditorGUILayout.VerticalScope(GUI.skin.box))
            {
                ...
                PubEditorUX.DisplayProperty(Prop_DisplayLandscape, new GUIContent("LANDSCAPE DISPLAY FORMAT:"), GUILayout.MaxWidth(600));
                PubEditorUX.DisplayProperty(Prop_DisplayPotrait, new GUIContent("PORTRAIT DISPLAY FORMAT:"), GUILayout.MaxWidth(600));
                ...
                //         PubEditorUX.DisplayProperty(Prop_DisplayLandscape, new GUIContent("Ads with Landscape Product Image"), GUILayout.MaxWidth(600));
                //         PubEditorUX.DisplayProperty(Prop_DisplayPotrait, new GUIContent("Ads with Portrait Product Image"), GUILayout.MaxWidth(600));
                //         PubEditorUX.DisplayProperty(Prop_CoOpAd, new GUIContent("Ads without Product Image"), GUILayout.MaxWidth(600));
