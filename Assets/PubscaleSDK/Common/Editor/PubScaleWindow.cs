    ...
    public class PubScaleWindow : EditorWindow
    {
        ...
        public void OnGUI()
        {
            ...
            using (new EditorGUILayout.VerticalScope(GUI.skin.box))
            {
                ...
                if (image != null)
                {
                    GUI.DrawTexture(new Rect(EditorGUIUtility.currentViewWidth / 2 - imageWidth / 2, 45, imageWidth, imageHeight), image, ScaleMode.ScaleToFit);
                }
            }
            ...
            using (new EditorGUILayout.VerticalScope(GUI.skin.box))
            {
                ...
                GUILayout.BeginArea(new Rect(20, imageHeight + 55, position.width - margin * 2, position.height - imageHeight + 2 * margin));
